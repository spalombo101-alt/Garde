...
function isClassMember(node /*: ESNode */) /*: implies node is ClassMember */{
  return node.type === 'PropertyDefinition' || node.type === 'MethodDefinition' || node.type === 'AbstractMethodDefinition' || node.type === 'AbstractPropertyDefinition' || node.type === 'ObjectTypeIndexer' || node.type === 'StaticBlock';
}
function isClassMemberWithNonComputedName(node /*: ESNode */) /*: implies node is ClassMemberWithNonComputedName */{
  return (node.type === 'PropertyDefinition' || node.type === 'MethodDefinition' || node.type === 'AbstractMethodDefinition' || node.type === 'AbstractPropertyDefinition') && node.computed === false;
}
