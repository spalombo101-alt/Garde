...
const LazyDrawerLayoutAndroid = props => {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(DrawerLayoutAndroidImpl, {
    ...props
  });
};
LazyDrawerLayoutAndroid.displayName = 'DrawerLayoutAndroid';
const DrawerLayoutAndroid = exports.DrawerLayoutAndroid = (0, _createNativeWrapper.default)(LazyDrawerLayoutAndroid, {
  disallowInterruption: true
});
// eslint-disable-next-line @typescript-eslint/no-redeclare
