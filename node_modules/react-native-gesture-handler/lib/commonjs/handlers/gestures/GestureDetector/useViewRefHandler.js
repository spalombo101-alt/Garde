...
function useViewRefHandler(state, updateAttachedGestures) {
  const refHandler = (0, _react.useCallback)(ref => {
    ...
    if (state.previousViewTag === -1) {
      state.previousViewTag = (0, _findNodeHandle.default)((0, _hostInstance.resolveHostInstance)(state.viewRef));
    }
    ...
    if (__DEV__ && (0, _utils.isFabric)() && global.isViewFlatteningDisabled) {
      const node = (0, _getShadowNodeFromRef.getShadowNodeFromRef)((0, _hostInstance.resolveHostInstance)(ref));
