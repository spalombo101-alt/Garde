...
exports.isHostInstance = isHostInstance;
exports.preferHostInstance = preferHostInstance;
exports.resolveHostInstance = resolveHostInstance;
...
function isHostInstance(instance) {
  return instance?.__internalInstanceHandle !== undefined;
}
function preferHostInstance(instance) {
...
function resolveHostInstance(ref) {
